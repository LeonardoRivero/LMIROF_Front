      ...
      <Container component="main" maxWidth="md">
        ...
        >
          <Typography component="h1" variant="h5" color={"black"}>
            New Product {JSON.stringify(context)}
          </Typography>
          <SimpleSnackbar />
          <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <InputLabel id="demo">Distribution Type</InputLabel>
                <Select
                  labelId="demo"
                  fullWidth
                  required
                  id="distributionProductType"
                  value={state.distributionProductType}
                  label="distributionProductType"
                  name="distributionProductType"
                  onChange={handleChange}
                >
                  {state.listDistributionProductType.length === 0 ? (
                    <MenuItem disabled value="">
                      <em>None</em>
                    </MenuItem>
                  ) : (
                    state.listDistributionProductType.map((distProducttype) => {
                      return (
                        <MenuItem key={distProducttype.id} value={distProducttype.id}>
                          {distProducttype.description}
                        </MenuItem>
                      );
                    })
                  )}
